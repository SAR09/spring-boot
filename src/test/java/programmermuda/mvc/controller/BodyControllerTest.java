...
import programmermuda.mvc.model.HelloRequest;
import programmermuda.mvc.model.HelloResponse;
...
public class BodyControllerTest {
    ...
    void bodyHello() throws Exception {
        ...
        mockMvc.perform(
            ...
            assertEquals("Hello Saiful", response.getHello());
        });
    }
}
